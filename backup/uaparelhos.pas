...
procedure TFAparelho.Button5Click(Sender: TObject);
begin
  frReportAparelho.LoadFromFile('RfAparelhos.lrf');
  frReportAparelho.PrepareReport;
  frReportAparelho.ShowReport;
end;
